import pytest
import os
from triz_agent.context import WorkflowContext, SAO, ConvergenceDecision, Solution, SolutionDraft, QualitativeTags
from tests.helpers import formulate_problem
from triz_agent.tools.m7_convergence import check_convergence
from triz_agent.tools.m2_gate import should_trigger_m2
from triz_agent.tools.fos_search import search_cases
...
def setup_db(tmp_path_factory):
    ...
    import triz_agent.config
    import triz_agent.database.init_db
    import triz_agent.database.queries
...
def test_search_local_cases(monkeypatch):
    from triz_agent.context import SearchResult
    ...
    monkeypatch.setattr("triz_agent.tools.fos_search._search_serpapi", mock_search_serpapi)
    monkeypatch.setattr("triz_agent.tools.fos_search._get_cache", lambda q: None)
    monkeypatch.setattr("triz_agent.tools.fos_search._set_cache", lambda q, r: None)
