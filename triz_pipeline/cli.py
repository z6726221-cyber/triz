...
class TRIZPipelineConsole:
    """TRIZ Pipeline 交互式控制台。"""
...
"""
    ...
    def _on_event(self, event_type: str, data: dict):
        if event_type == "node_start":
            node = {
                "node_name": data.get("node_name", "未知"),
...
def main():
    ...
    if args.query:
        ...
        console_app = TRIZPipelineConsole()
        console_app.run()
